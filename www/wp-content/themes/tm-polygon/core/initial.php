...
function admin_head() {
	wp_enqueue_style( 'infinity-custom-admin-css', TM_POLYGON_THEME_ROOT . '/core/css/custom.css' );
}
...
function infinity_customize_control_js() {
	wp_enqueue_script( 'skin-control', TM_POLYGON_THEME_ROOT . '/core/customizer/js/skin-control.js', array( 'customize-controls', 'iris', 'underscore', 'wp-util' ), '20141216', true );
}
