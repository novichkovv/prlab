...
Kirki::add_field( 'tm-polygon', array(
	...
	'label'       => esc_html__( 'Menu icon color', 'tm-polygon' ),
	'section'     => $section,
	'priority'    => $priority ++,
	'default'     => '#111',
...
Kirki::add_field( 'tm-polygon', array(
	...
	'description' => esc_html__( 'Link color hover', 'tm-polygon' ),
	'section'     => $section,
	'priority'    => $priority ++,
	...
	'output'      => array(
		array(
			'element'  => '#site-navigation .menu > ul > li > a:hover, #site-navigation .menu > li > a:hover',
			'property' => 'color',
		),
		array(
